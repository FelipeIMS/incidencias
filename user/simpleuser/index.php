...
<body>
    ...
    <div class="col-md-4">
        <div class="card text-center">
            ...
            <div class="card-body">
                <form id="combo" name="combo" action="guarda.php" method="POST">
                    <div class="mt-3">Selecciona Servicio : <select required name="combo_servicio" id="combo_servicio">
                    ...
                    <div class="mt-3 mb-3">Selecciona Tipo de Servicio : <select required name="combo_ts" id="combo_ts"></select></div>
		...
		<a class="btn btn-primary mt-5" href="../../includes/logout.php">Logout</a>
    </div>
	<div class="col-md-8">
		dfds
	</div>
