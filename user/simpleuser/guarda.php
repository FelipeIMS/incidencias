...
if(empty($_POST['combo_ts'])||empty($_POST['select_area']) || empty($_POST['fecha_inicio'])){
    ...
    $sql = "INSERT INTO incidencias (observacion, fechaInicio, fechaFin, id_servicio_1, id_area_1, id_tipoServicio_1) VALUES('$observacion','$fecha_inicio',null,'$id_servicio_1','$id_area_1','$id_tipoServicio_1')";
